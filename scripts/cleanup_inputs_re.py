...
def calculate_similarities(path_to_folder):
    ...
    embedder = SentenceTransformer("Alibaba-NLP/gte-multilingual-base", trust_remote_code=True)
    ...
    for csv_file in glob.glob(path_to_folder+"*.csv"):
        ...
        # store as json
        with open(path_to_folder+file_name+"2.jsonlines", "w", encoding="utf-8") as output_file:
